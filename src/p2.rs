...
impl RegisterBlock {
    #[doc = "0x01 - Port 2 Input register"]
    #[inline(always)]
    pub const fn p2in(&self) -> &P2in {
        &self.p2in
    }
    #[doc = "0x03 - Port 2 Output register"]
    #[inline(always)]
    pub const fn p2out(&self) -> &P2out {
        &self.p2out
    }
    #[doc = "0x05 - Port 2 Direction register"]
    #[inline(always)]
    pub const fn p2dir(&self) -> &P2dir {
        &self.p2dir
    }
    #[doc = "0x07 - Port 2 Resistor Enable register"]
    #[inline(always)]
    pub const fn p2ren(&self) -> &P2ren {
        &self.p2ren
    }
    #[doc = "0x0b - Port 2 Selection register bit 0"]
    #[inline(always)]
    pub const fn p2sel0(&self) -> &P2sel0 {
        &self.p2sel0
    }
    #[doc = "0x0d - Port 2 Selection register bit 1"]
    #[inline(always)]
    pub const fn p2sel1(&self) -> &P2sel1 {
        &self.p2sel1
    }
    #[doc = "0x17 - Port 2 Complement Select register"]
    #[inline(always)]
    pub const fn p2selc(&self) -> &P2selc {
        &self.p2selc
    }
    #[doc = "0x19 - Port 2 Interrupt Edge Select register"]
    #[inline(always)]
    pub const fn p2ies(&self) -> &P2ies {
        &self.p2ies
    }
    #[doc = "0x1b - Port 2 Interrupt Enable register"]
    #[inline(always)]
    pub const fn p2ie(&self) -> &P2ie {
        &self.p2ie
    }
    #[doc = "0x1d - Port 2 Interrupt Flag register"]
    #[inline(always)]
